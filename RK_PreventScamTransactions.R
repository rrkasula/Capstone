...
creditcard <- read.csv("C:/Users/19787/Documents/Projects/Capstone/creditcard.csv")
...
# partition  dataset into train, test  and cv
...
# Clone the credit card dataframe
...
pred <- prediction(
  as.numeric(as.character(baseline_model$Class)),
...
# Create a data frame 'output' that contains all metrics 
...
# Create a Naive Bayes Model, it will improve
...
# Adding the respective metrics to the output dataset
